...
namespace DOTA_CUE
{
	class InputHandler
	{
		...
		public void handleInput()
		{
			...
			//intro
			Console.WriteLine("Dota 2 Lighting for Corsair RGB Keyboard");
			...
			do
			{
				...
				switch (input.ToLower())
				{
					...
					case "-h":
						...
						break;
					//Signal the dota api core to start if it isin't already running.
					case "-start":
					case "-s":
						if (Core.gameListener.gsl != null && Core.gameListener.gsl.Running)
